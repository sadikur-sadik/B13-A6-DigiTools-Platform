    ...
    return (
        <div className='w-full bg-[#f9fafcFF] md:py-30 py-20 space-y-10'>
            ...
            <div className='lg:max-w-300 max-w-180 w-full mx-auto grid md:grid-cols-2 lg:grid-cols-3 grid-cols-1 gap-4'>
                <section className='flex  flex-col justify-center rounded-xl py-22.5 px-6 relative space-y-4 shadow-lg'>
                    <div className="badge from-0% to-100% bg-linear-to-r absolute from-purple-700 w-8 h-8 rounded-full via-purple-600 to-purple-500 text-white text-md font-bold top-10 right-10">1</div>
                ...
                <section className='flex  flex-col justify-center rounded-xl py-22.5 px-6 relative space-y-4 shadow-lg'>
                    <div className="badge from-0% to-100% bg-linear-to-r absolute from-purple-700 w-8 h-8 rounded-full via-purple-600 to-purple-500 text-white text-md font-bold top-10 right-10">2</div>
                ...
                <section className='flex  flex-col justify-center rounded-xl  py-22.5 px-6 relative space-y-4 shadow-lg'>
                    <div className="badge from-0% to-100% bg-linear-to-r absolute from-purple-700 w-8 h-8 rounded-full via-purple-600 to-purple-500 text-white text-md font-bold top-10 right-10">3</div>
