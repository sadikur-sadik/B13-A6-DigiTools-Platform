        ...
        <div className='lg:max-w-300 max-w-180 w-full mx-auto'>
            <div className="navbar">
                <div className="navbar-start">
                    ...
                    <a className="font-bold md:py-3 py-0 md:text-2xl lg:text-4xl text-xl bg-linear-to-r from-purple-700 via-purple-600 to-purple-500  bg-clip-text text-transparent">DigiTools</a>
                </div>
